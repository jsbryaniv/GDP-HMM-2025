...
class MOEWrapper3d(nn.Module):
    ...
    def __init__(self, model, in_channels, out_channels, n_experts=4, **kwargs):
        ...
        # Set up gating layer
        self.gating = MOEGating3d(in_channels, n_experts)
